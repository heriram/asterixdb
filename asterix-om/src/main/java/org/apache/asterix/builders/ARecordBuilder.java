...
public class ARecordBuilder implements IARecordBuilder {
    ...
    /**
     * Get the updated record type.
     *
     * @return
     *     ARecordType the updated record type
     */
    public ARecordType getRecType() {
        return this.recType;
    }
    ...
    public void write(DataOutput out, boolean writeTypeTag) throws IOException, AsterixException {
        write(out, writeTypeTag, false);
    }

    public void write(DataOutput out, boolean writeTypeTag, boolean print) throws IOException, AsterixException {
        int h = headerSize;
        int recordLength;
    ...
    public String printRecord(int h, boolean writeTypeTag, int recordLength) throws IOException, AsterixException {
        ...
        IVisitablePointable recordVisitablePointable = pa.allocateRecordValue(recType);
        recordVisitablePointable.set(abvs.getByteArray(), abvs.getStartOffset(), abvs.getLength());


        ARecordPrinterFactory recordPrinter = new ARecordPrinterFactory(recType);
        IPrinter rp = recordPrinter.createPrinter();

        try {
            rp.print(abvs.getByteArray(), abvs.getStartOffset(), abvs.getLength(), ps);
