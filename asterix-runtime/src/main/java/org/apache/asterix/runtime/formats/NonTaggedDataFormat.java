...
import org.apache.asterix.runtime.evaluators.functions.AnnotatedBytesDescriptor;
...
public class NonTaggedDataFormat implements IDataFormat {
    ...
    public void registerRuntimeFunctions() throws AlgebricksException {
        ...
        temp.add(AnnotatedBytesDescriptor.FACTORY);
    ...
    void registerTypeInferers() {
        ...
        functionTypeInferers.put(AsterixBuiltinFunctions.ADM_TO_BYTES, new FunctionTypeInferer() {
            ...
            @Override public void infer(ILogicalExpression expr, IFunctionDescriptor fd,
                ...
                IAType intype0 = (IAType) context.getType(f.getArguments().get(0).getValue());
                IAType intype1 = (IAType) context.getType(f.getArguments().get(1).getValue());
                ((AnnotatedBytesDescriptor) fd).reset(outType, intype0, intype1);
            }
        });
